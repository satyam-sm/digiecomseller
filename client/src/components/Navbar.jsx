    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        >
          ...
          <button className="absolute -top-2 -right-3 text-xs text-white bg-[#a45f53] w-[18px] h-[18px] rounded-full">
            {cartCount()}
          </button>
        </div>
        ...
        {user ? (
          ...
          <button
            ...
            className="cursor-pointer px-8 py-2 bg-[#a45f53] hover:bg-[#cd8072] transition text-white rounded-full"
          >
            Login
          </button>
        )}
